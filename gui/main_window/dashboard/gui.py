...
class Dashboard(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        # Valeur du nombre de chambres disponibles
        canvas.create_text(
            164.0, 63.0,
            anchor="ne",
        ...
        # --- Carte Valeur Totale de l'Hôtel ---
        ...
        # Légende pour le statut général
        canvas.create_text(
            235.0, 200.0,
            anchor="nw",
            text="Réservées",
        ...
        # Légende pour le graphique par type (à compléter si besoin)
        ...
        entry_10.place(x=219.0, y=186.0 + 2, width=64.0, height=0)
                ...
                # Indicateur couleur pour "Disponibles" (bleu)
        ...
        # Indicateur couleur pour "Réservées" (gris)
        ...
        # Indicateur pour le graphique "Par type" (Deluxe)
        ...
        # Indicateur couleur bleu pour Deluxe
        ...
        # Indicateur couleur gris pour Normal
        ...
        # Légende par type de chambre
        canvas.create_text(
            539.693603515625, 200.0,
            anchor="nw",
            text="Deluxe",
            fill="#5E95FF",
            font=("Montserrat Bold", 13 * -1),
        ...
        # Graphique 1 : Répartition Disponibles / Réservées
        ...
        # Graphique 2 : Répartition par type de chambre (Deluxe / Standard)
